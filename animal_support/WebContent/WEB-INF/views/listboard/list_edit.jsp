...
<body>
	<div class="container">
		...
		<section>
			...
			<hr>
			<form action="${pageContext.request.contextPath}/listboard/list_edit_ok.do" method="post" enctype="multipart/form-data">
			...
			<table class="table">
				<tr>
					<td>
						...
						<input type="text" name="title" id="title" class="form-control" value="[+] ${readListboard.listtitle}">
					</td>
				</tr>		
				<tr>
					<td>
				...
				<tr>
					<td id="noti_com">
						<div class="form-group">
				            <div>
				                <textarea name="content" id="content" class="summernote"/>${readListboard.listcont}</textarea>
				            </div>
				        </div>
					</td>
				</tr>
