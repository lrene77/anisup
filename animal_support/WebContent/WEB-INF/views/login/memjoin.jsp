...
<!-- join -->
<link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/assets/css/login/join.css">
	...
	<div class="container">
		...
		<section>
			...
			<small id="small1">*표시 된 부분은 필수 입력사항입니다.</small><small id="small2"><span
				class="glyphicon glyphicon-home"> &gt; 개인 회원 가입</span></small>
			<hr />
			<!-- 가입폼 시작 -->
			<div id="use">
				<p>
			...
			<div class="col-md-12">
				<form class="form-horizontal" method="post"
					action="${pageContext.request.contextPath}/login/memjoin_ok.do"
					id="join">
					<p id="use-check">
					...
					<div class="form-group" id="ok-button">
						<div class="col-sm-12">
							...
							<button class="btn btn-danger" type="button" id="join-remove" onclick="history.back();">
