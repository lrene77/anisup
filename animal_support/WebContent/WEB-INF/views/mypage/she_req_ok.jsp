		...
		<section>
			...
			<form class="form-horizontal" role="form" id="join">
				...
				<div class="form-group">
					...
					<div class="col-md-6">
						<input type="text" class="form-control" name="my_title"value="${req.reqtitle }">
					</div>
				</div>
				<!-- 이름  -->
				<div class="form-group">
					...
					<div class="col-md-6">
						<input type="text" class="form-control" name="my_name"value="${req.name}">
					</div>
				</div>
				<!--폰 앞자리 셀렉트-->
				<div class="form-group">
					...
					<div class="col-md-6">
						<input type="text" class="form-control" name="my_phone" value="${req.tel}">
					</div>
				</div>
				<!-- 주소 박스 -->
				<div class="form-group">
					...
					<div class="col-md-6">
						<input type="text" class="form-control" name="my_juso" value="${req.addr1 }">
					</div>
					<!-- col-md 박스  -->
				</div>
				<!-- 그룹 박스-->
				<div class="form-group">
					...
					<div class="col-md-6">
						<input type="text" class="form-control" name="my_job" value="${req.reqjob }">
					</div>
					<!-- col-md 박스 -->
				</div>
				<!--그룹 박스 -->
				...
				<div class="form-group">
					...
					<div class="col-md-6">
						<textarea class="form-control" name="my_info" id="my_info"
							style="resize: none" id="my_info">${req.reqcont}
						</textarea>
					</div>
				</div>
				<!--col-md 박스-->
