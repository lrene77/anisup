...
<!-- 모바일 웹 페이지 설정 -->
<link rel="shortcut icon" href="${pageContext.request.contextPath}/assets/ico/favicon_1.ico" />
...
<link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/assets/css/small.css" />

<!-- 우편번호 javascript -->
<script src="${pageContext.request.contextPath}/assets/js/addressAPI.js"></script>
