	...
	<ul class="pagination">
		...
		<c:choose>
			<c:when test="${pageHelper.prevPage > 0}">
				...
				<c:url var="prevUrl" value="/admin/listboard/info/admin_qna_list.do">
		...
		<c:forEach var="i" begin="${pageHelper.startPage}"
			...
			<c:url var="pageUrl" value="/admin/listboard/info/admin_qna_list.do">
		...
		<c:choose>
			<c:when test="${pageHelper.nextPage > 0}">
				...
				<c:url var="nextUrl" value="/admin/listboard/info/admin_qna_list.do">
