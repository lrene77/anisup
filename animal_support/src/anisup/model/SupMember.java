...
public class SupMember {
	...
	public String toString() {
		return "SupMember [supno=" + supno + ", suptitle=" + suptitle + ", supcont=" + supcont + ", supstart="
				+ supstart + ", supend=" + supend + ", supprice=" + supprice + ", supnow=" + supnow + ", supstat="
				+ supstat + ", suping=" + suping + ", supbill=" + supbill + ", supacname=" + supacname + ", supbank="
				+ supbank + ", supacc=" + supacc + ", wdate=" + wdate + ", mno=" + mno + ", supDays=" + supDays
				+ ", mtype=" + mtype + ", limitStart=" + limitStart + ", listCount=" + listCount + "]";
	}
