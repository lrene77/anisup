...
@WebServlet("/mypage/mem_upd_ok.do")
public class MemUpdOk extends BaseController {
	private static final long serialVersionUID = 489944628950781651L;
	...
	public String doRun(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		//파라미터 return
		String name = web.getString("mem-name");
		String id = web.getString("mem-id");
		String Pw = web.getString("mem-pw");
		String email = web.getString("mem-eamil");
		String tel = web.getString("mem-tel");
		String birth = web.getString("mem-birthdate");
		String phone = web.getString("mem-phone");
		String postcode = web.getString("postcode");
		String addr1 = web.getString("address");
		String addr2 = web.getString("address1");
		String pwq = web.getString("mem-re");
		String pwa = web.getString("mem-answer");
		
		String newUserPw = web.getString("new-user-pw");
		String newUserPwRe = web.getString("new-user-pw-re");
