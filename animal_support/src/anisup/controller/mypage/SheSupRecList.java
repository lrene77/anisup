...
@WebServlet("/mypage/she_sup_rec_list.do")
public class SheSupRecList extends BaseController {
	private static final long serialVersionUID = 6554070503779624893L;
	...
	try {
		...
		return "mypage/she_sup_rec_list";
	}
}
