...
@WebServlet("/mypage/she_sup_list.do")
public class SheSupList extends BaseController {
	private static final long serialVersionUID = 2879079357628983063L;
	...
	public String doRun(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			supList = supJoinService.myJoinSheSupList(supJoin);
		} catch(Exception e) {
