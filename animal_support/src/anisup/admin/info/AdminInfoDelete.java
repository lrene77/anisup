...
/**
 * Servlet implementation class AdminInfoDelete
 */
@WebServlet("/admin/listboard/info/admin_info_delete.do")
public class AdminInfoDelete extends BaseController {
	private static final long serialVersionUID = 6633639657884591356L;
	Logger logger;
	...
	public String doRun(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		/**(9)*/
		String url = "%s/admin/listboard/info/admin_info_list.do";
