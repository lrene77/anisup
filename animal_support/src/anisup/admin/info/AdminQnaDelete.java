...
/**
 * Servlet implementation class AdminQnaDelete
 */
@WebServlet("/admin/listboard/info/admin_qna_delete.do")
public class AdminQnaDelete extends BaseController {
	private static final long serialVersionUID = -4369779989138580349L;
	Logger logger;
	...
	public String doRun(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		/**(9)*/
		String url = "%s/admin/listboard/info/admin_qna_list.do";
