...
/**
 * Servlet implementation class AdminSupSearch
 */
@WebServlet("/admin/sup/admin_sup_search.do")
public class AdminSupSearch extends BaseController {

	private static final long serialVersionUID = 5659883900891923120L;
	...
	public String doRun(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		request.setAttribute("radio", supstat);
